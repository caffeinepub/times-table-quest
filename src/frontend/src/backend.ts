...
export class Backend implements backendInterface {
    ...
    async getScoresByPlayer(arg0: string): Promise<Array<ScoreEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getScoresByPlayer(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveScore(arg0: string, arg1: bigint, arg2: bigint, arg3: Array<bigint>): Promise<void> {
        if (this.processError) {
            try {
